...
export function DetailSidebar({ activeSection }: { activeSection: string }) {
  ...
  return (
    <div
      className={`bg-sidebar box-border content-stretch flex flex-col gap-4 h-full items-start justify-start overflow-visible p-4 relative rounded-r-2xl shrink-0 transition-all duration-500 ${
